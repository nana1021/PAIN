  ...
  <div class="jumbotron bg-danger text-white mb-0 radius-0 ht-tm-jumbotron">
    <div class="container">
      <div class="ht-tm-header">
        <h1 class="display-1 text-chicle text-light">パンを焼く</h1>
...
{{--
    ...
    <nav>
     ...
     <div class="pain-image">
      <img src="Pan Yaku/html/images/bread.png"alt="パンのイラスト"class="pain-image">
     </div>
        </main>
